...
export var LinkFontFamily = 'Poppins, sans-serif';
export var MaxWidth = 1150;
// export const ColorBackground = "#fdf8f7"
// export const ColorForeground = "#fff"
export var ColorPink = '#fdf8f7';
export var ColorBackground = '#fff';
export var ColorForeground = '#fafafa';
// export const ColorForeground = '#fdf8f7'
// export const BORDER_COLOR = 'rgba(0,0,0,.1)'
export var ColorBorder = 'rgba(0,0,0,1)';
export var BorderWidth = 2;
export var Section = styled(Box).attrs({})(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  max-width: 100%;\n  display: flex;\n  position: relative;\n  flex-direction: column;\n  align-items: center;\n  padding: 80px 0;\n  /* overflow: hidden; // by default, might be overridden... */\n\n  > div,\n  > header,\n  > section {\n    max-width: ", "px;\n    width: 100%;\n    text-align: left;\n  }\n\n  @media (max-width: 800px) {\n    padding: 40px 20px 40px;\n    font-size: 12px;\n  }\n\n  p {\n    font-size: 20px;\n    line-height: 1.8;\n  }\n\n  a {\n    /* color: #ce00ff; */\n  }\n\n  h1,\n  h2,\n  h3 {\n    color: inherit;\n\n    i {\n      opacity: 0.6;\n    }\n  }\n"], ["\n  max-width: 100%;\n  display: flex;\n  position: relative;\n  flex-direction: column;\n  align-items: center;\n  padding: 80px 0;\n  /* overflow: hidden; // by default, might be overridden... */\n\n  > div,\n  > header,\n  > section {\n    max-width: ", "px;\n    width: 100%;\n    text-align: left;\n  }\n\n  @media (max-width: 800px) {\n    padding: 40px 20px 40px;\n    font-size: 12px;\n  }\n\n  p {\n    font-size: 20px;\n    line-height: 1.8;\n  }\n\n  a {\n    /* color: #ce00ff; */\n  }\n\n  h1,\n  h2,\n  h3 {\n    color: inherit;\n\n    i {\n      opacity: 0.6;\n    }\n  }\n"])), function (props) { var _a; return ((_a = props.theme) === null || _a === void 0 ? void 0 : _a.maxWidth) || MaxWidth; });
export var ParagraphStyle = styled.div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  font-size: 20px;\n\n  & > h1 {\n    color: inherit;\n    font-size: 1.2em;\n    line-height: 1.5;\n    /* letter-spacing: .5px; */\n    font-weight: 500;\n  }\n\n  & > h2 {\n    color: inherit;\n    font-size: 1em;\n    line-height: 1.4;\n    /* margin-bottom: 10px; */\n    max-width: 700px;\n  }\n\n  & > h4 {\n    color: inherit;\n    font-weight: 700;\n    line-height: 1.4;\n    font-size: 18px;\n    text-transform: uppercase;\n    opacity: 0.2;\n  }\n\n  & > h3 {\n    color: inherit;\n    font-weight: 500;\n    line-height: 1.4;\n    font-size: 22px;\n    /* opacity: .6; */\n    /* color: #bf0023; */\n  }\n\n  & > p {\n    margin-bottom: 1em;\n    line-height: 1.7;\n    font-weight: 400;\n    font-size: 1em;\n    color: #666;\n\n    strong,\n    a {\n      opacity: 1;\n      font-weight: 600;\n      color: #000;\n    }\n  }\n"], ["\n  font-size: 20px;\n\n  & > h1 {\n    color: inherit;\n    font-size: 1.2em;\n    line-height: 1.5;\n    /* letter-spacing: .5px; */\n    font-weight: 500;\n  }\n\n  & > h2 {\n    color: inherit;\n    font-size: 1em;\n    line-height: 1.4;\n    /* margin-bottom: 10px; */\n    max-width: 700px;\n  }\n\n  & > h4 {\n    color: inherit;\n    font-weight: 700;\n    line-height: 1.4;\n    font-size: 18px;\n    text-transform: uppercase;\n    opacity: 0.2;\n  }\n\n  & > h3 {\n    color: inherit;\n    font-weight: 500;\n    line-height: 1.4;\n    font-size: 22px;\n    /* opacity: .6; */\n    /* color: #bf0023; */\n  }\n\n  & > p {\n    margin-bottom: 1em;\n    line-height: 1.7;\n    font-weight: 400;\n    font-size: 1em;\n    color: #666;\n\n    strong,\n    a {\n      opacity: 1;\n      font-weight: 600;\n      color: #000;\n    }\n  }\n"])));
export var PageHeader = styled(Flex).attrs({
    // width: [1, 1, MaxWidth],
    width: 1,
    margin: 'auto',
...
export var SectionGroup = styled.div(templateObject_9 || (templateObject_9 = __makeTemplateObject(["\n  overflow: hidden; // by default, might be overridden...\n  background: transparent;\n\n  ", "\n  ", "\n  ", "\n\nfilter: ", ";\n\n  @media (max-width: 800px) {\n    border-bottom: 2px solid #00000011;\n    border-bottom-width: ", ";\n  }\n\n  ", ";\n"], ["\n  overflow: hidden; // by default, might be overridden...\n  background: transparent;\n\n  ", "\n  ", "\n  ", "\n\nfilter: ", ";\n\n  @media (max-width: 800px) {\n    border-bottom: 2px solid #00000011;\n    border-bottom-width: ", ";\n  }\n\n  ", ";\n"])), function (props) {
    return props.black && css(templateObject_5 || (templateObject_5 = __makeTemplateObject(["\n      background: black;\n    "], ["\n      background: black;\n    "])));
}, function (props) {
    return props.white && css(templateObject_6 || (templateObject_6 = __makeTemplateObject(["\n      background: ", ";\n    "], ["\n      background: ", ";\n    "])), ColorPink);
}, function (props) {
    return props.white &&
        props.invert && css(templateObject_7 || (templateObject_7 = __makeTemplateObject(["\n      background: white;\n    "], ["\n      background: white;\n    "])));
}, function (props) { return (props.invert ? 'invert(1)' : 'none'); }, function (props) {
    return (props.white && ColorForeground) || props.invert ? '0' : '2px';
}, function (props) {
    return props.invert && css(templateObject_8 || (templateObject_8 = __makeTemplateObject(["\n      img:not(.invertable) {\n        filter: invert(1);\n      }\n\n      .revert {\n        filter: invert(1);\n      }\n    "], ["\n      img:not(.invertable) {\n        filter: invert(1);\n      }\n\n      .revert {\n        filter: invert(1);\n      }\n    "])));
});
export var SectionHeader = styled.div(templateObject_11 || (templateObject_11 = __makeTemplateObject(["\n  width: 100%;\n  margin-bottom: 30px;\n\n  ", "\n\n  @media (max-width: 800px) {\n    padding-left: 10px;\n  }\n\n  &&& {\n    h1 {\n      font-size: 1.4em;\n      text-transform: uppercase;\n      font-weight: 500;\n      letter-spacing: 1.5px;\n      opacity: 1;\n    }\n  }\n"], ["\n  width: 100%;\n  margin-bottom: 30px;\n\n  ", "\n\n  @media (max-width: 800px) {\n    padding-left: 10px;\n  }\n\n  &&& {\n    h1 {\n      font-size: 1.4em;\n      text-transform: uppercase;\n      font-weight: 500;\n      letter-spacing: 1.5px;\n      opacity: 1;\n    }\n  }\n"])), function (props) {
    return props.center && css(templateObject_10 || (templateObject_10 = __makeTemplateObject(["\n      text-align: center;\n      display: flex;\n      align-items: center;\n      flex-direction: column;\n      h1 {\n        text-align: center;\n      }\n    "], ["\n      text-align: center;\n      display: flex;\n      align-items: center;\n      flex-direction: column;\n      h1 {\n        text-align: center;\n      }\n    "])));
});
export var CentralizedContainer = styled(Section)(templateObject_12 || (templateObject_12 = __makeTemplateObject(["\n  padding-top: 40px;\n  padding-bottom: 40px;\n\n  h1 {\n    text-align: center;\n    margin-bottom: 40px;\n    font-size: 22px;\n  }\n"], ["\n  padding-top: 40px;\n  padding-bottom: 40px;\n\n  h1 {\n    text-align: center;\n    margin-bottom: 40px;\n    font-size: 22px;\n  }\n"])));
export var RelativeBox = styled(Box)(templateObject_13 || (templateObject_13 = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
export function FadeInSection(props) {
    var controls = useAnimation();
    var _a = useInView(), ref = _a[0], inView = _a[1];
    useEffect(function () {
        if (inView) {
            controls.start('visible');
        }
    }, [controls, inView]);
    return (<motion.div ref={ref} animate={controls} initial={'hidden'} style={{
...
export var BlurBall = styled.div(templateObject_14 || (templateObject_14 = __makeTemplateObject(["\n  position: relative;\n  right: 10px;\n  /* opacity: ; */\n  bottom: 30px;\n  top: 10px;\n  z-index: 10;\n\n  &::before {\n    filter: blur(100px);\n    position: absolute;\n    width: 240px;\n    height: 240px;\n    background: ", ";\n  }\n"], ["\n  position: relative;\n  right: 10px;\n  /* opacity: ; */\n  bottom: 30px;\n  top: 10px;\n  z-index: 10;\n\n  &::before {\n    filter: blur(100px);\n    position: absolute;\n    width: 240px;\n    height: 240px;\n    background: ", ";\n  }\n"])), function (props) {
    return ({
        yellow: 'gold',
        pink: '#F16994',
        green: '#F19469',
...
export function LogoNotification(props) {
    ...
    return (<LogoNotificationContainer onClick={onClick}>
